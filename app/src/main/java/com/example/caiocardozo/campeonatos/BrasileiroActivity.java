...
public class BrasileiroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] brasileiroArray = getResources().getStringArray(R.array.ArrayBrasileiro);
        //cria o array com a descrição dos times
        String[] brasileiroDescArray = getResources().getStringArray(R.array.ArrayBrasileiroDesc);
        ...
        for (int i = 0; i < 10; i++) {
            String titulo = brasileiroArray[i];
            String desc = brasileiroDescArray[i];
        ...
        ItemAdapter adapter = new ItemAdapter(this, list, R.color.Brasileiro_Categoria);

        //atribui o adapter ao layout
        ListView listView = findViewById(R.id.rootBrasileiro);
